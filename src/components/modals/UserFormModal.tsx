...
export const UserFormModal: React.FC<UserFormModalProps> = ({
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        className="bg-white dark:bg-cardbg-dark border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl w-full max-w-md overflow-hidden text-left relative animate-in zoom-in-95 duration-150"
