  ...
  return (
    <div className="space-y-6 text-left animate-in fade-in duration-200">
      ...
      {isModalOpen && ReactDOM.createPortal(
        ...
        >
          <div
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-xl overflow-hidden shadow-2xl flex flex-col text-left relative animate-in zoom-in-95 duration-150"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto max-h-[80vh] scroll-smooth">
              <div>
              ...
              {/* Multi-Image File Selection & Drag & Drop Upload (Up to 5 images) */}
              <div className="pt-2">
                <ImageUploaderManager
                  ...
                  maxImages={5}
                  minImages={1}
                  label="Package Bundle Images (Up to 5)"
                />
              </div>
